...
type Profile struct {
	...
	AccountIdInt        int32                `protobuf:"varint,29,opt,name=account_id_int,json=accountIdInt,proto3" json:"account_id_int,omitempty"`
	...
	QueryLogStream      bool                 `protobuf:"varint,30,opt,name=query_log_stream,json=queryLogStream,proto3" json:"query_log_stream,omitempty"`
...
type FilterConfig struct {
	...
	CustomRuleList *FilterConfig_CustomRuleList `protobuf:"bytes,6,opt,name=custom_rule_list,json=customRuleList,proto3" json:"custom_rule_list,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
// Deprecated: Use FilterConfig_CustomRuleList.ProtoReflect.Descriptor instead.
func (*FilterConfig_CustomRuleList) Descriptor() ([]byte, []int) {
...
func (x *FilterConfig_CategoryFilter) Reset() {
	*x = FilterConfig_CategoryFilter{}
	mi := &file_filecache_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FilterConfig_CategoryFilter) Descriptor() ([]byte, []int) {
	return file_filecache_proto_rawDescGZIP(), []int{4, 7}
}
...
const file_filecache_proto_rawDesc = "" +
	...
	"\aversion\x18\x04 \x01(\x05R\aversion\"\xe3\x10\n" +
	"\aProfile\x12H\n" +
	...
	"\x10query_log_stream\x18\x1e \x01(\bR\x0equeryLogStream\x12e\n" +
	...
	"\x0fcategory_filter\x18\x05 \x01(\v2(.filecachepb.FilterConfig.CategoryFilterB\x02\x18\x01R\x0ecategoryFilter\x12R\n" +
	"\x10custom_rule_list\x18\x06 \x01(\v2(.filecachepb.FilterConfig.CustomRuleListR\x0ecustomRuleList\x1aD\n" +
	"\x06Custom\x12\x14\n" +
	...
	"\x03sun\x18\a \x01(\v2\x18.filecachepb.DayIntervalR\x03sun\x1a<\n" +
...
var file_filecache_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_filecache_proto_goTypes = []any{
	...
	(*FilterConfig_CustomRuleList)(nil),     // 21: filecachepb.FilterConfig.CustomRuleList
	(*FilterConfig_RuleList)(nil),           // 22: filecachepb.FilterConfig.RuleList
	(*FilterConfig_SafeBrowsing)(nil),       // 23: filecachepb.FilterConfig.SafeBrowsing
	(*FilterConfig_CategoryFilter)(nil),     // 24: filecachepb.FilterConfig.CategoryFilter
	(*timestamppb.Timestamp)(nil),           // 25: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),             // 26: google.protobuf.Duration
}
var file_filecache_proto_depIdxs = []int32{
	25, // 0: filecachepb.FileCache.sync_time:type_name -> google.protobuf.Timestamp
	...
	26, // 11: filecachepb.Profile.filtered_response_ttl:type_name -> google.protobuf.Duration
	...
	22, // 25: filecachepb.FilterConfig.rule_list:type_name -> filecachepb.FilterConfig.RuleList
	23, // 26: filecachepb.FilterConfig.safe_browsing:type_name -> filecachepb.FilterConfig.SafeBrowsing
	24, // 27: filecachepb.FilterConfig.category_filter:type_name -> filecachepb.FilterConfig.CategoryFilter
	21, // 28: filecachepb.FilterConfig.custom_rule_list:type_name -> filecachepb.FilterConfig.CustomRuleList
	13, // 29: filecachepb.Device.authentication:type_name -> filecachepb.AuthenticationSettings
	12, // 30: filecachepb.Access.allowlist_cidr:type_name -> filecachepb.CidrRange
	12, // 31: filecachepb.Access.blocklist_cidr:type_name -> filecachepb.CidrRange
	12, // 32: filecachepb.Ratelimiter.client_cidr:type_name -> filecachepb.CidrRange
	25, // 33: filecachepb.CustomDomainConfig.StateCurrent.not_before:type_name -> google.protobuf.Timestamp
	25, // 34: filecachepb.CustomDomainConfig.StateCurrent.not_after:type_name -> google.protobuf.Timestamp
	25, // 35: filecachepb.CustomDomainConfig.StatePending.expire:type_name -> google.protobuf.Timestamp
	19, // 36: filecachepb.FilterConfig.Parental.pause_schedule:type_name -> filecachepb.FilterConfig.Schedule
	24, // 37: filecachepb.FilterConfig.Parental.category_filter:type_name -> filecachepb.FilterConfig.CategoryFilter
	20, // 38: filecachepb.FilterConfig.Schedule.week:type_name -> filecachepb.FilterConfig.WeeklySchedule
	5,  // 39: filecachepb.FilterConfig.WeeklySchedule.mon:type_name -> filecachepb.DayInterval
	5,  // 40: filecachepb.FilterConfig.WeeklySchedule.tue:type_name -> filecachepb.DayInterval
	5,  // 41: filecachepb.FilterConfig.WeeklySchedule.wed:type_name -> filecachepb.DayInterval
	5,  // 42: filecachepb.FilterConfig.WeeklySchedule.thu:type_name -> filecachepb.DayInterval
	5,  // 43: filecachepb.FilterConfig.WeeklySchedule.fri:type_name -> filecachepb.DayInterval
	5,  // 44: filecachepb.FilterConfig.WeeklySchedule.sat:type_name -> filecachepb.DayInterval
	5,  // 45: filecachepb.FilterConfig.WeeklySchedule.sun:type_name -> filecachepb.DayInterval
